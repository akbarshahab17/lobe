...
import logo from "../assets/lobe.png";

export const Footer = () => {
  return (
    <footer className="bg-neutral-primary-soft border border-gray-200 my-12">
        <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
            <div className="md:flex md:justify-between">
            <div className="mb-6 md:mb-0">
                <a href="/" className="flex items-center">
                    <img src={logo} className="h-7 me-2" alt="Lobe Logo" />
                    <span className="text-heading self-center text-2xl font-semibold whitespace-nowrap">Lobe</span>
                </a>
                <span className="text-sm text-body sm:text-center">© 2030 <a href="/" className="hover:underline">Lobe™</a>. All Rights Reserved.
                </span>
            </div>
            <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-4">
                <div>
                ...
                <a href="https://github.com/akbarshahab17" className="text-body hover:text-heading ms-5">
